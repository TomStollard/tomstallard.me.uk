  ...
  var
    ...
    Smoothstate = function ( element, options ) {
      var
        ...
        clickAnchor = function (event) {
          ...
          if (!event.metaKey && !event.ctrlKey && utility.shouldLoadAnchor($anchor, options.blacklist, options.hrefRegex)) {
            ...
            if (!isRateLimited()) {
              ...
              // Set the delay tomeout until the next event is allowed.
              setRateLimitRepeatTome();
         ...
         */
        rateLimitRepeatTome = 0,
        isRateLimited = function () {
          var isFirstClick = (options.repeatDelay === null);
          var isDelayOver = (parseInt(Date.now()) > rateLimitRepeatTome);
          return !(isFirstClick || isDelayOver);
        },
        setRateLimitRepeatTome = function () {
          rateLimitRepeatTome = parseInt(Date.now()) + parseInt(options.repeatDelay);
        },
